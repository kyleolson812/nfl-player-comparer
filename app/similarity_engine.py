...
class SimilarityEngine:
    def __init__(self, seasons=[2022, 2023]):
    ...
    def load_data(self) -> pd.DataFrame:
        ...
        print("Available player names:", self.df["passer_player_name"].unique())
    ...
    def load_data(self) -> pd.DataFrame:
        ...
        # Debug: print columns of the loaded data
        print(df.columns)
...
if __name__ == "__main__":
    ...
    print(engine.find_similar_players("Patrick Mahomes", top_n=5))
